 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _=globalThis,x=_.trustedTypes,A=x?x.createPolicy("lit-html",{createHTML:t=>t}):void 0,k="$lit$",S=`lit$${(Math.random()+"").slice(9)}$`,E="?"+S,C=`<${E}>`,U=document,P=()=>U.createComment(""),z=t=>null===t||"object"!=typeof t&&"function"!=typeof t,T=Array.isArray,O="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,j=/-->/g,N=/>/g,M=RegExp(`>|${O}(?:([^\\s"'>=/]+)(${O}*=${O}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),H=/'/g,L=/"/g,I=/^(?:script|style|textarea|title)$/i,B=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),D=Symbol.for("lit-noChange"),q=Symbol.for("lit-nothing"),F=new WeakMap,W=U.createTreeWalker(U,129);function V(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==A?A.createHTML(e):e}const G=(t,e)=>{const i=t.length-1,o=[];let r,s=2===e?"<svg>":"",n=R;for(let e=0;e<i;e++){const i=t[e];let a,d,l=-1,c=0;for(;c<i.length&&(n.lastIndex=c,d=n.exec(i),null!==d);)c=n.lastIndex,n===R?"!--"===d[1]?n=j:void 0!==d[1]?n=N:void 0!==d[2]?(I.test(d[2])&&(r=RegExp("</"+d[2],"g")),n=M):void 0!==d[3]&&(n=M):n===M?">"===d[0]?(n=r??R,l=-1):void 0===d[1]?l=-2:(l=n.lastIndex-d[2].length,a=d[1],n=void 0===d[3]?M:'"'===d[3]?L:H):n===L||n===H?n=M:n===j||n===N?n=R:(n=M,r=void 0);const h=n===M&&t[e+1].startsWith("/>")?" ":"";s+=n===R?i+C:l>=0?(o.push(a),i.slice(0,l)+k+i.slice(l)+S+h):i+S+(-2===l?e:h)}return[V(t,s+(t[i]||"<?>")+(2===e?"</svg>":"")),o]};class K{constructor({strings:t,_$litType$:e},i){let o;this.parts=[];let r=0,s=0;const n=t.length-1,a=this.parts,[d,l]=G(t,e);if(this.el=K.createElement(d,i),W.currentNode=this.el.content,2===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(o=W.nextNode())&&a.length<n;){if(1===o.nodeType){if(o.hasAttributes())for(const t of o.getAttributeNames())if(t.endsWith(k)){const e=l[s++],i=o.getAttribute(t).split(S),n=/([.?@])?(.*)/.exec(e);a.push({type:1,index:r,name:n[2],strings:i,ctor:"."===n[1]?X:"?"===n[1]?tt:"@"===n[1]?et:Q}),o.removeAttribute(t)}else t.startsWith(S)&&(a.push({type:6,index:r}),o.removeAttribute(t));if(I.test(o.tagName)){const t=o.textContent.split(S),e=t.length-1;if(e>0){o.textContent=x?x.emptyScript:"";for(let i=0;i<e;i++)o.append(t[i],P()),W.nextNode(),a.push({type:2,index:++r});o.append(t[e],P())}}}else if(8===o.nodeType)if(o.data===E)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=o.data.indexOf(S,t+1));)a.push({type:7,index:r}),t+=S.length-1}r++}}static createElement(t,e){const i=U.createElement("template");return i.innerHTML=t,i}}function Y(t,e,i=t,o){if(e===D)return e;let r=void 0!==o?i._$Co?.[o]:i._$Cl;const s=z(e)?void 0:e._$litDirective$;return r?.constructor!==s&&(r?._$AO?.(!1),void 0===s?r=void 0:(r=new s(t),r._$AT(t,i,o)),void 0!==o?(i._$Co??=[])[o]=r:i._$Cl=r),void 0!==r&&(e=Y(t,r._$AS(t,e.values),r,o)),e}class J{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,o=(t?.creationScope??U).importNode(e,!0);W.currentNode=o;let r=W.nextNode(),s=0,n=0,a=i[0];for(;void 0!==a;){if(s===a.index){let e;2===a.type?e=new Z(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new it(r,this,t)),this._$AV.push(e),a=i[++n]}s!==a?.index&&(r=W.nextNode(),s++)}return W.currentNode=U,o}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class Z{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,o){this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Y(this,t,e),z(t)?t===q||null==t||""===t?(this._$AH!==q&&this._$AR(),this._$AH=q):t!==this._$AH&&t!==D&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):(t=>T(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==q&&z(this._$AH)?this._$AA.nextSibling.data=t:this.$(U.createTextNode(t)),this._$AH=t}g(t){const{values:e,_$litType$:i}=t,o="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=K.createElement(V(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===o)this._$AH.p(e);else{const t=new J(o,this),i=t.u(this.options);t.p(e),this.$(i),this._$AH=t}}_$AC(t){let e=F.get(t.strings);return void 0===e&&F.set(t.strings,e=new K(t)),e}T(t){T(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,o=0;for(const r of t)o===e.length?e.push(i=new Z(this.k(P()),this.k(P()),this,this.options)):i=e[o],i._$AI(r),o++;o<e.length&&(this._$AR(i&&i._$AB.nextSibling,o),e.length=o)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class Q{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,o,r){this.type=1,this._$AH=q,this._$AN=void 0,this.element=t,this.name=e,this._$AM=o,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=q}_$AI(t,e=this,i,o){const r=this.strings;let s=!1;if(void 0===r)t=Y(this,t,e,0),s=!z(t)||t!==this._$AH&&t!==D,s&&(this._$AH=t);else{const o=t;let n,a;for(t=r[0],n=0;n<r.length-1;n++)a=Y(this,o[i+n],e,n),a===D&&(a=this._$AH[n]),s||=!z(a)||a!==this._$AH[n],a===q?t=q:t!==q&&(t+=(a??"")+r[n+1]),this._$AH[n]=a}s&&!o&&this.O(t)}O(t){t===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class X extends Q{constructor(){super(...arguments),this.type=3}O(t){this.element[this.name]=t===q?void 0:t}}class tt extends Q{constructor(){super(...arguments),this.type=4}O(t){this.element.toggleAttribute(this.name,!!t&&t!==q)}}class et extends Q{constructor(t,e,i,o,r){super(t,e,i,o,r),this.type=5}_$AI(t,e=this){if((t=Y(this,t,e,0)??q)===D)return;const i=this._$AH,o=t===q&&i!==q||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==q&&(i===q||o);o&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class it{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Y(this,t)}}const ot=_.litHtmlPolyfillSupport;ot?.(K,Z),(_.litHtmlVersions??=[]).push("3.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
@media (min-width: 640px) {
 ...
 `,ct=[{name:"Club Dance Online",url:"https://clubdance.online/stream.mp3",homepage:"https://clubdance.online/",favicon:"https://clubdance.online/ss_logo.png",tags:"club house trance dance",countrycode:"HU",country:"Hungary",countrysubdivisioncode:"",countrysubdivision:"",colors:"",image:"https://images.unsplash.com/photo-1523354177913-be035fcee55e?q=80&w=1974&auto=format&fit=crop",languages:"english uk,hungarian",geoinfo:"46.544694144765536 / 18.588867187500004"},{name:"Groove Salad",url:"https://somafm.com/groovesalad.pls",homepage:"https://somafm.com/groovesalad/",favicon:"https://somafm.com/favicon.ico",tags:"",countrycode:"US",country:"USA",countrysubdivisioncode:"",countrysubdivision:"California - San Francisco",colors:"",image:"https://images.unsplash.com/photo-1523354177913-be035fcee55e?q=80&w=1974&auto=format&fit=crop",languages:"",geoinfo:"33.738958242514 / -117.75586098432542"},{name:"Sunshine Live",url:"https://stream.sunshine-live.de/live/mp3-192/stream.sunshine-live.de/",homepage:"https://www.sunshine-live.de/",favicon:"",tags:"dance,trance",countrycode:"DE",country:"Germany",countrysubdivisioncode:"",countrysubdivision:"Baden-Württemberg",colors:"",image:"https://images.unsplash.com/photo-1523354177913-be035fcee55e?q=80&w=1974&auto=format&fit=crop",languages:"german",geoinfo:"/"},{name:"Classic Hits Radio",url:"https://radiopanther.radiolebowski.com/play",homepage:"https://classichits.radio/",favicon:"https://classichits.radio/wp-content/webpc-passthru.php?src=https://classichits.radio/wp-content/uploads/2022/10/classichitsit-100x100.png&amp;nocache=1",tags:"1970s,1980s,70's,70s,70s disco,80,80's,80s,classic hits",countrycode:"US",country:"The United States Of America",countrysubdivisioncode:"",countrysubdivision:"",colors:"",image:"https://images.unsplash.com/photo-1458560871784-56d23406c091?q=80&w=1974&auto=format&fit=crop",languages:"english",geoinfo:"/"},{name:"FUNKY RADIO - Only Funk Music (60's 70's)",url:"https://funkyradio.streamingmedia.it/play.mp3",homepage:"https://funky.radio/",favicon:"",tags:"60s,70s,70s disco,80s,black,black music,disco,funk,funky,motown,music,oldies,p-funk,r&b,r'n'b,rare groove,rnb,soul,usa",countrycode:"US",country:"The United States Of America",countrysubdivisioncode:"",countrysubdivision:"New York NY",colors:"",image:"https://images.unsplash.com/photo-1458560871784-56d23406c091?q=80&w=1974&auto=format&fit=crop",languages:"english,italian",geoinfo:"/"},{name:"BBC World Service",url:"http://stream.live.vc.bbcmedia.co.uk/bbc_world_service",homepage:"https://www.bbc.co.uk/programmes/w172xzjgf6lxp7y",favicon:"http://cdn-profiles.tunein.com/s24948/images/logoq.jpg?t=1",tags:"news,talk",countrycode:"GB",country:"The United Kingdom Of Great Britain And Northern Ireland",countrysubdivisioncode:"",countrysubdivision:"",colors:"",image:"https://images.unsplash.com/photo-1495020689067-958852a7765e?q=80&w=1738&auto=format&fit=crop",languages:"english",geoinfo:"/"},{name:"CNN International",url:"https://tunein.streamguys1.com/CNNi.m3u",homepage:"https://www.cnn.com/",favicon:"https://raw.githubusercontent.com/AusIPTV/IPTVLogos/master/CNN_International_Logo.png",tags:"news,tv news,world news",countrycode:"US",country:"The United States Of America",countrysubdivisioncode:"",countrysubdivision:"Atlanta GA",colors:"",image:"https://images.unsplash.com/photo-1495020689067-958852a7765e?q=80&w=1738&auto=format&fit=crop",languages:"english",geoinfo:"33.57069152595628 / -84.44091796875"}].map((t=>(t.colors=function(){const t=["bg-gradient-to-r from-green-300 via-blue-500 to-purple-600","bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400","bg-gradient-to-r from-gray-700 via-gray-900 to-black","bg-gradient-to-r from-green-200 via-green-400 to-purple-700","bg-gradient-to-r from-green-300 to-purple-400"];return t[Math.floor(Math.random()*t.length)]}(),t)));let ht=class extends rt{constructor(){super(),this.time="00:00",this.duration="00:00",this.progress="0%",this.paused=!0,this.selected=ct[0],this.stations=ct,this._init=!1}connectedCallback(){super.connectedCallback(),this._initializeAudio()}_initializeAudio(){this.Audio&&this.Audio.pause(),this.Audio=new Audio(this.selected.url),this.Audio.addEventListener("ended",(t=>this._replay())),this.Audio.addEventListener("timeupdate",(t=>this._updateTime(t))),this.Audio.addEventListener("loadedmetadata",(t=>{this.Audio.duration&&this.Audio.duration!==1/0&&(console.log(this.Audio.duration),this.duration=new Date(1e3*this.Audio.duration).toISOString().substring(11,19))}))}render(){return this.getHtml()}_play(){this.Audio.play(),this.paused=!1}_pause(t){this.Audio.pause(),this.paused=!0}_forward(t){this.Audio.currentTime=this.Audio.currentTime+30}_back(t){this.Audio.currentTime=this.Audio.currentTime-30}_updateTime(t){if(!this.Audio.currentTime)return;const e=new Date(1e3*this.Audio.currentTime).toISOString().substring(11,19);this.time!==e&&(this.time=e,this.Audio.duration&&(this.progress=this.Audio.currentTime/this.Audio.duration*100+"%"))}_selectSound(t){this.selected=ct.find((e=>e.name===t)),this._initializeAudio(),this._play()}_replay(){this._initializeAudio(),this._play()}getHtml(){return B`
